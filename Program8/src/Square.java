...
public class Square extends Parallelogram{
    ...
    //Square constructor that accepts four points objects as arguments
    public Square(Point point1, Point point2, Point point3, Point point4){
        super(point1, point2, point3, point4);
    }

    //Square constructor that accepts eight doubles to initialize coordinates
    public Square(double xPoint1, double yPoint1, double xPoint2, double yPoint2,
    ...
    //Override toString method from superclass Parallelogram
    @Override
